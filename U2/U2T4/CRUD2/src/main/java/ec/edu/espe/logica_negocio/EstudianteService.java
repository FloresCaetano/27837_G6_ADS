...
import ec.edu.espe.datos.factory.AbstractRepositoryFactory;
import ec.edu.espe.datos.factory.RepositoryFactory;
...
public class EstudianteService {
	...
	public EstudianteService() {
		AbstractRepositoryFactory factory = new RepositoryFactory();
		this.repository = factory.createEstudianteRepository();
	}
