...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| COMP-BE-V1 | Diagrama de Componente Backend | V1.0.0 | 14/01/2026 | Caetano Flores, Jordan Guaman, Anthony Morales, Leonardo Narvaez | 27837_G6_ADS\DISEÑOS\1.5 Diagrama De Componentes | Primera version del diagrama backend | Español | Windows |
| COMP-BE-V2 | **Diagrama de Componentes Backend** | V2.0.0 (Básico) | 27/01/2026 | Caetano Flores, Jordan Guaman, Anthony Morales, Leonardo Narvaez | 27837_G6_ADS\DISEÑOS\1.5 Diagrama De Componentes\ **COMP_BE_KairosMix_V2.pdf** | Vista general de arquitectura y navegación | Español | Windows |
